...
def run_ga(jumlah_generasi, jumlah_populasi, prob_crossover, prob_mutasi, ukuran_maksimal_gudang):
    ...
    # Menampilkan grafik fitness (di luar loop generasi, di dalam fungsi run_ga)
    ...
    selected_value = hitung_fitness(best_individu, barang, ukuran_maksimal_gudang)
    ...
    print(f"Total Ukuran (Bobot): {selected_weight}")
